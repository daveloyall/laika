...
Tabs = {
    ...
    GoTo: function (contentId, skipReplace) {
        ...
        // Get the TOC element.
        var toc = document.getElementById("error_report_toc");
        if (toc) {
        ...
        for (var i = 0; i < divs.length; i++) {
            ...
            if (div.className.match(/\btest_results\b/i)) {
...
if (document.createStyleSheet) {
    ...
    style.addRule("div.test_results", "display: none;");
    ...
    if (head) {
        ...
        style.appendChild(document.createTextNode("div.test_results { display: none; }"));
